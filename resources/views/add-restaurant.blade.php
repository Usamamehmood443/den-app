      ...
      <!-----------------------------------Mobile SIdebar End------------------------------------  -->
        ...
        <!-- Header END  -->
            ...
            <div class="row mt-40 mb-5">
              <div class="col-12">
                <div class="text-end">
                  <a href="add-restaurant.html" class="text-danger fs-24 fw-semibold">Save Restaurant</a>
                </div>
              </div>
              <div class="col-12">
                <form class="row gx-5 gy-3 add-restaurant" method="" action="">
                  <div class="col-12">
                    <h6 class="text-white fs-16 fw-bold mb-20">Add Restuarant</h6>
                    <h6 class="text-white fs-16 fw-500 mb-0">Enter Restaurant Basic Detail:</h6>
                  </div>
                  <div class="col-md-6">
                    <input type="text" class="form-control h-60px bg-light border-0" id="restaurant_name" name="restaurant-name" placeholder="Restaurant Name">
                  </div>
                  <div class="col-md-6">
                    <input type="email" class="form-control h-60px bg-light border-0" id="" name="email" placeholder="Email">
                  </div>
                  <div class="col-md-6">
                    <input type="text" class="form-control h-60px bg-light border-0" id="company_registration" name="company-registration" placeholder="Company Registration #">
                  </div>
                  <div class="col-md-6">
                    <input type="text" class="form-control h-60px bg-light border-0" id="zimra_bp" name="zimra-bp" placeholder="Zimra BP #">
                  </div>
                  <!-- Enter/Select Address: BEGIN -->
                  <div class="col-12">
                    <div class="d-flex justify-content-between">
                      <h6 class="text-white fs-16 fw-500 mb-0">Enter/Select Address: </h6>
                      <a href="#" class="text-primary text-decoration-none">
                        <span class="me-2">
                          <svg width="20" height="25" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.25 5V8.75H15V11.25H11.25V15H8.75V11.25H5V8.75H8.75V5H11.25ZM17.5 10.25C17.5 5.7125 14.1875 2.5 10 2.5C5.8125 2.5 2.5 5.7125 2.5 10.25C2.5 13.175 4.9375 17.05 10 21.675C15.0625 17.05 17.5 13.175 17.5 10.25ZM10 0C15.25 0 20 4.025 20 10.25C20 14.4 16.6625 19.3125 10 25C3.3375 19.3125 0 14.4 0 10.25C0 4.025 4.75 0 10 0Z" fill="#2A7CF8"/>
                            </svg>                            
                        </span>
                        Select From Maps
                      </a>
                  ...
                  <div class="col-12">
                    <input type="text" class="form-control h-60px bg-light border-0" id="address_one" name="address-one" placeholder="Address 1">
                  </div>
                  <div class="col-12">
                    <input type="text" class="form-control h-60px bg-light border-0" id="address_two" name="address-two" placeholder="Address 2">
                  </div>
                  <!-- Enter/Select Address: END -->
                   <!-- Select Opening & Closing Time: BEGIN -->
                  <div class="col-12">
                    <h6 class="text-white fs-16 fw-500 mb-0">Select Opening & Closing Time</h6>
                  </div>
                  <div class="col-md-6">
                    <label for="" class="form-label text-white fs-16 fw-400">Open Time:</label>
                    <input type="time" class="form-control h-60px bg-light border-0" id="open_time" name="open-time">
                  </div>
                  <div class="col-md-6">
                    <label for="" class="form-label text-white fs-16 fw-400">Open Time:</label>
                    <input type="time" class="form-control h-60px bg-light border-0" id="open_time" name="open-time">
                  </div>
                  <!-- Select Opening & Closing Time: END -->
                  <!-- Select Food Category: BEGIN -->
                  <div class="col-12">
                    <h6 class="text-white fs-16 fw-500 mb-0">Select Food Category:</h6>
                  </div>
                  <div class="col-md-6">
                    <div class="dine-in p-3 d-flex align-items-center justify-content-between h-60px bg-light border-0 border-radius-10">
                      <h6 class="text-white fs-16 fw-500 mb-0">Dine In: </h6>
                      <div class="d-flex gap-5">
                        <div class="form-check">
                          <input class="form-check-input dineIn_check" type="checkbox"  id="defaultCheck1" checked>
                          <label class="form-check-label text-secondary fs-16 fw-400" for="defaultCheck1" >
                            Yes
                          </label>
                        </div>
                        <div class="form-check me-lg-4">
                          <input class="form-check-input dineIn_check" type="checkbox"  id="defaultCheck2">
                          <label class="form-check-label text-secondary fs-16 fw-400" for="defaultCheck2">
                            No
                          </label>
                        </div>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="dine-in p-3 d-flex align-items-center justify-content-between h-60px bg-light border-0 border-radius-10">
                      <h6 class="text-white fs-16 fw-500 mb-0">Service Type</h6>
                      <div class="d-flex gap-5">
                        <div class="form-check">
                          <input class="form-check-input service_check" type="checkbox"  id="defaultCheck1">
                          <label class="form-check-label text-secondary fs-16 fw-400" for="defaultCheck1">
                            Self
                          </label>
                        </div>
                        <div class="form-check me-lg-4">
                          <input class="form-check-input service_check" type="checkbox"  id="defaultCheck2" checked>
                          <label class="form-check-label text-secondary fs-16 fw-400" for="defaultCheck2">
                            Table
                          </label>
                        </div>
                  ...
                  <!-- Select Food Category: END -->
                  <!-- Upload Image:: BEGIN -->
                  <div class="col-12 mt-20">
                    <h6 class="text-white fs-16 fw-500 mb-0">Upload Image:</h6>
                  </div>
                  <div class="col-12">
                    <div class="upload-card">
                      <div class="avatar-upload">
                        ...
                        <div class="avatar-preview">
                            <div id="imagePreview" style="background-image: url(./assets/images/upload-icon.svg);">
                            </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <!-- Upload Image:: END -->
                  <!-- Restaurant Contact Person Info:: BEGIN -->
                  <div class="col-12 mt-20">
                    <h6 class="text-white fs-16 fw-500 mb-0">Restaurant Contact Person Info:</h6>
                  </div>
                  <div class="col-md-6">
                    <input type="text" class="form-control h-60px bg-light border-0" id="" name="Name" placeholder="Name">
                  </div>
                  <div class="col-md-6">
                    <input type="email" class="form-control h-60px bg-light border-0" id="" name="email" placeholder="Email">
                  </div>
                  <div class="col-md-6">
                    <input type="number" class="form-control h-60px bg-light border-0" id="phone_number" name="phone-number" placeholder="Phone">
                  </div>
                  <div class="col-md-6">
                    <input type="text" class="form-control h-60px bg-light border-0" id="" name="designation" placeholder="Designation">
                  </div>
                  <!-- Restaurant Contact Person Info:: END -->
                </form>
              </div>
            </div>
            <!-- -------END--------- -->
...
// DINE IN 
$(function () {
  $('.dineIn_check').click(function(e) {
    $('.dineIn_check').not(this).prop('checked', false);
  });
});

// SERVICE TYPE 
$(function () {
  $('.service_check').click(function(e) {
    $('.service_check').not(this).prop('checked', false);
  });
});
</script>
