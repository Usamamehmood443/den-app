        ...
        <!-- Header END  -->
            ...
            <div class="row  mt-30">
                <div class="col-md-3 col-12">
                    <div class="bg-black py-24 border-radius-10">
              ...
              <div class="col-lg-6 col-md-12 col-12">
                  <div class="text-start">
                    ...
                    <div class="contact-card">
                      <div class="mb-30">
                        <h6 class="text-white fw-bold fs-16 mb-1">Email Address</h6>
                        <p class="text-white fw-500 fs-16 mb-0">williamsdev@example.com</p>
                      </div>
                      <div class="mb-30">
                        <h6 class="text-white fw-bold fs-16 mb-1">Phone Number</h6>
                        <p class="text-white fw-500 fs-16 mb-0">+1  323 3262921</p>
                      </div>
                      <div class="">
                        <h6 class="text-white fw-bold fs-16 mb-1">Delivery Address</h6>
                        <p class="text-white fw-500 fs-16 mb-20">2055 Limestone Rd STE 200C <br>
                          Wilmington, Delaware, 19808, US</p>
                      </div>
                    </div>
              </div>
              <div class="col-lg-6 col-md-12 col-12">
                <div class="d-flex justify-content-between px-4 mb-25">
                  <h6 class="text-secondary fw-400 mb-0">Order Details</h6>
                  <h6 class="text-secondary fw-400 mb-0">Order Status</h6>
                </div>
                <div class="contact-card">
                  <div class="row">
                    <div class="col-6">
                      <ul class="list-unstyled p-0 mb-0">
                        <li class="d-flex text-white fw-bold gap-4 mb-20">
                          <span>1.</span>
                          <span>#24697</span>
                        </li>
                        <li class="d-flex text-white fw-bold gap-4 mb-20">
                        ...
                        <li class="d-flex text-white fw-bold gap-4">
                          <span>6.</span>
                          <span>#24697</span>
                        </li>
                      </ul>
                    ...
                    <div class="col-6">
                      <ul class="list-unstyled text-end mb-0">
                        <li class="mb-20">
                          <span class="badge fs-16 fw-400 text-success p-0">Paid</span>
                        </li>
                        <li class="mb-20">
                          <span class="badge fs-16 fw-400 text-danger p-0">UnPaid</span>
                        </li>
                        <li class="mb-20">
                          <span class="badge fs-16 fw-400 text-success p-0">Complete</span>
                        </li>
                        <li class="mb-20">
                          <span class="badge fs-16 fw-400 text-warning p-0">Pending</span>
                        </li>
                        <li class="mb-20">
                          <span class="badge fs-16 fw-400 text-danger p-0">Rejected</span>
                        </li>
                        <li>
                          <span class="badge fs-16 fw-400 text-success p-0">Paid</span>
                        </li>
            ...
            <div class="row mt-50">
              <div class="col-12">
                <a type="button" class="text-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Suspend Account</a>
              </div>
            </div>
            <!-- -------END--------- -->
            <!-- Customer Detail End  -->
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content bg-black">
      ...
      <div class="modal-body">
        <h5 class="text-white fs-16">Do you want to suspend this account </h5>
      </div>
